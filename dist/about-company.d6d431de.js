...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"scripts/about-company.js":[function(require,module,exports) {
"use strict";
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var breakpointChecker = function breakpointChecker() {
    ...
    if (mql.matches !== true) {
      if (teamSliders !== undefined) {
        teamSliders.forEach(function (e, i) {
  ...
  var enableSwiper = function enableSwiper() {
    var sliders = _toConsumableArray(document.querySelectorAll('.s-teams__swiper'));
    var _iterator = _createForOfIteratorHelper(sliders),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var slider = _step.value;
        var teamSlider = new _swiperBundle.default(slider, {
          slidesPerView: 'auto',
          slidesPerGroup: 1,
          loop: false,
          centeredSlides: true,
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/about-company.js"], null)
//# sourceMappingURL=/about-company.d6d431de.js.map